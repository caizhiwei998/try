...
def fabu_diqu_mon(conn,width,height,mon):
    ...
    fabu_diqu_title = str(mon)[:4] + '年' + str(mon)[-2:] + '月土流网发布土地区域分布'
...
def fabu_type_mon(conn,width,height,zs_mj,mon):
    ...
    if zs_mj=='zs':
        fabu_type_title1 = str(mon)[:4] + '年' + str(mon)[-2:] + '月土流网发布土地类型宗数占比'
        ...
        fabu_type_title2 = str(mon)[:4] + '年' + str(mon)[-2:] + '月土流网发布土地类型面积占比'
...
def fabu_liuzhuan_mon(conn,width,height,zs_mj,mon):
    ...
    if zs_mj=='zs':
        fabu_liuzhuan_title1= str(mon)[:4] + '年' + str(mon)[-2:] + '月土流网发布土地流转类型宗数占比'
        ...
        fabu_liuzhuan_title2 = str(mon)[:4] + '年' + str(mon)[-2:] + '月土流网发布土地流转类型面积占比'
...
def fabu_nianxian_mon(conn,width,height,mon):
    ...
    fabu_nianxian_title= str(mon)[:4] + '年' + str(mon)[-2:] + '月土流网各土地类型平均流转年限'
...
def jiaoyi_diqu_mon(conn,width,height,mon):
    ...
    jiaoyi_diqu_title = str(mon)[:4] + '年' + str(mon)[-2:] + '月土流网交易区域分布'
...
def jiaoyi_type_mon(conn,width,height,zs_mj,mon):
    ...
    if zs_mj == 'zs':
        jiaoyi_type_title1 = str(mon)[:4] + '年' + str(mon)[-2:] + '月土流网交易土地类型宗数占比'
        ...
        jiaoyi_type_title2 = str(mon)[:4] + '年' + str(mon)[-2:] + '月土流网交易土地类型面积占比'
...
def jiaoyi_liuzhuan_mon(conn,width,height,zs_mj,mon):
    ...
    if zs_mj=='zs':
        jiaoyi_liuzhuan_title1 = str(mon)[:4] + '年' + str(mon)[-2:] + '月土流网交易土地流转类型宗数占比'
        ...
        jiaoyi_liuzhuan_title2 = str(mon)[:4] + '年' + str(mon)[-2:] + '月土流网交易土地流转类型面积占比'
...
def jiaoyi_nianxian_mon(conn,width,height,mon):
    ...
    jiaoyi_nianxian_title = str(mon)[:4] + '年' + str(mon)[-2:] + '月土流网交易土地各土地类型平均流转年限'
...
def jiaoyi_haoshi_mon(conn,width,height,mon):
    ...
    jiaoyi_haoshi_title = str(mon)[:4] + '年' + str(mon)[-2:] + '月土流网成交土地平均耗时（天）'
...
def xuqiu_type_mon(conn,width,height,zs_mj,mon):
    ...
    if zs_mj=='zs':
        xuqiu_type_title1 = str(mon)[:4] + '年' + str(mon)[-2:] + '月土流网土地需求类型宗数占比'
    ...
    if zs_mj == 'mj':
        xuqiu_type_title2 = str(mon)[:4] + '年' + str(mon)[-2:] + '月土流网土地需求类型面积占比'
